...
function Brand() {
  return (
    <a className="brand" href="#home" aria-label="やすらぎデイサービス トップ">
      <img src={`${assets}logo.png`} alt="" />
      <span>
        <strong>やすらぎデイサービス</strong>
        <small>笑顔でつながる、もうひとつの我が家</small>
      </span>
    </a>
  );
}
    ...
    <div className="page-shell">
      ...
      <main id="main">
        <section className="hero" aria-labelledby="hero-title">
          <img
            ...
            src={`${assets}day-service-hero.png`}
            alt="明るい施設で笑い合う高齢の女性とスタッフのイメージ"
            fetchPriority="high"
          />
          <div className="hero-copy">
            ...
            <div className="hero-benefits">
              {[
                [Heart, "安心・安全の", "サポート"],
                [UsersThree, "楽しい仲間と", "豊かな時間"],
                [HouseLine, "心と体の", "健康づくり"],
              ].map(([I, a, b]) => (
                <div key={a}>
        ...
        <section id="services" className="services section-pad">
          <div className="section-heading">
              <h2>楽しく、健やかに。<br />多彩なプログラム</h2>
              <p>体を動かすレクリエーションや、創作活動、季節のイベントなど、一日を楽しめるプログラムをご用意しています。</p>
          </div>
      ...
      <footer className="footer">
        ...
        <div className="footer-bottom">
          <span>© 2024 やすらぎデイサービス. All rights reserved.</span>
          <div>
            <button
              onClick={() =>
                info(
        ...
        <p className="template-notice">
          架空のデイサービス事業所のテンプレートです。写真・利用者の声・実績・料金・住所・電話番号は表示例です。相談送信・予約確定・決済は行いません。
        </p>
      </footer>
      {detail && (
        <DetailDialog
