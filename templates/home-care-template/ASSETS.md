...
参照：ユーザー提供 `/Users/suzukikenichi/Desktop/訪問介護.png`（854×1842px）。写真は個別に組み直し、見出し・本文・料金・ボタンをHTMLに分離する。
...
| body-care.png | 身体介護カード | 3:2 |
| housekeeping.png | 生活援助カード | 3:2 |
| outing.png | 通院・外出カード | 3:2 |
| watching.png | 見守り・安否確認カード | 3:2 |
| family-support.png | 家族支援カード | 3:2 |
...
854px幅でヘッダー46px、ヒーロー357px、お知らせ33px、サービス225px、理由125px、理念200px、声143px、流れ127px、料金・スタッフ166px、アクセス・FAQ201px、CTA126px、フッター94pxを目安とする。大きな写真、白い余白、紺の明朝見出し、青緑の線画アイコン、ピンクの丸いCTAを維持。PCは最大1440pxまで拡大、モバイルは読みやすさ優先で縦配置。
